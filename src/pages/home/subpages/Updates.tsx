...
export const UpdatesPage = () => {
  return (
    <div className="flex flex-col items-center justify-center font-extrabold max-w-6xl min-h-screen w-full">
      <h3 className="text-[#8E8E8E] text-2xl  text-center leading-[150%] tracking-[0.32em]">
        CONVERTING
      </h3>
      <h1 className="text-white text-8xl  text-center  drop-shadow-[0_0_2px_rgba(255,255,255,0.16)]">
